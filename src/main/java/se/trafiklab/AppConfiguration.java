...
public class AppConfiguration {
    ...
    public BusService busService() {
        return new BusServiceImpl(requestFactory(), client(), modelFactory(), topTenFunction());
    }
    ...
    public Function<Model<JourneyPatternPointOnLineModel>, List<BusLineInfo>> topTenFunction() {
        return new TopTenBusLineFunction(groupByLineNumber());
    }

    @Bean
    public Function<Model<JourneyPatternPointOnLineModel>, Map<Integer, Set<Integer>>> groupByLineNumber() {
